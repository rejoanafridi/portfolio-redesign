...
const projects = [
    {
        name: 'M - Flix',
        description:
            'MovieHub is a sleek and responsive movie discovery app built using the TMDB API. It allows users to explore a vast collection of movies, view detailed information, watch trailers, and search for their favorite films effortlessly. The app features a modern UI with smooth navigation, dynamic filtering, and responsive design, ensuring an engaging user experience across all devices',
        image: '/m-flix.png',
        status: 'done',
        github: 'https://github.com/rejoanafridi/m-flix',
        link: 'https://m-flix-chi.vercel.app/'
    },
    {
        name: 'Pc - Builder',
        description:
