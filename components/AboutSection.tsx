            ...
            <div className="my-12 pb-12 md:pt-16 md:pb-48">
                ...
                <div className="flex flex-col space-y-10 items-stretch justify-center align-top md:space-x-10 md:space-y-0 md:p-4 md:flex-row md:text-left">
                    <div className="md:w-1/2 ">
                        ...
                        <br />
                        <p>
                            I graduated from Daffodil International University
                            in 2022 with a BSC in Computer Engineering and have
                            been working in the field ever since.
                        </p>
                        <br />
                        <p>
                            Experienced Front-end software engineer,
                            specializing in React development . Proficient in
                            HTML, CSS, JavaScript, and modern frameworks.
                            Passionate about creating intuitive user interfaces
                            and collaborating with cross-functional teams.
                            Continuously learning to deliver cutting-edge
                            solutions. Eager to contribute and make a lasting
                            impact.
                        </p>
                        <br />
                        <p>
